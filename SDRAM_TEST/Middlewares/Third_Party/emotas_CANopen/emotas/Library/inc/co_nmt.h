...
*
*-------------------------------------------------------------------
* $Id: co_nmt.h 41687 2022-08-15 13:41:17Z boe $
*-------------------------------------------------------------------
*
*
*
...
*/
typedef enum {
	CO_NMT_REQ_STATE_UNKNOWN = 0,		/**< unknown */
...
EXTERN_DECL RET_T coGuardingInit(void);
...
EXTERN_DECL RET_T coHbConsumerStop(UNSIGNED8 node);
