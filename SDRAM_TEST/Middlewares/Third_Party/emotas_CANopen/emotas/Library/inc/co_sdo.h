...
*
*-------------------------------------------------------------------
* $Id: co_sdo.h 39657 2022-02-17 10:11:16Z boe $
*
*-------------------------------------------------------------------
*
*
 ...
 * \param index - object index
 * \param subindex - object subindex
 * \param domainBufSize - actual size at domain buffer (=0 on abort)
 * \param transferSize - actual transfered size (=0 on abort)
 * 
 * \return RET_T
 */
...
EXTERN_DECL RET_T coSdoServerWriteIndCont(UNSIGNED8 sdoNr,
				RET_T result);
EXTERN_DECL RET_T coSdoClientDomainWriteIndCont(UNSIGNED8 sdoNr,
				RET_T result);
