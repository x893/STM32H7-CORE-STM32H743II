...
typedef size_t (*mg_pm_t)(mg_pfn_t, void *, __va_list *);  // %M printer

size_t mg_vxprintf(void (*)(char, void *), void *, const char *fmt, __va_list *);
...
size_t mg_vsnprintf(char *buf, size_t len, const char *fmt, __va_list *ap);
size_t mg_snprintf(char *, size_t, const char *fmt, ...);
char *mg_vmprintf(const char *fmt, __va_list *ap);
char *mg_mprintf(const char *fmt, ...);
size_t mg_queue_vprintf(struct mg_queue *, const char *fmt, __va_list *);
size_t mg_queue_printf(struct mg_queue *, const char *fmt, ...);

// %M print helper functions
size_t mg_print_base64(void (*out)(char, void *), void *arg, __va_list *ap);
size_t mg_print_esc(void (*out)(char, void *), void *arg, __va_list *ap);
size_t mg_print_hex(void (*out)(char, void *), void *arg, __va_list *ap);
size_t mg_print_ip(void (*out)(char, void *), void *arg, __va_list *ap);
size_t mg_print_ip_port(void (*out)(char, void *), void *arg, __va_list *ap);
size_t mg_print_ip4(void (*out)(char, void *), void *arg, __va_list *ap);
size_t mg_print_ip6(void (*out)(char, void *), void *arg, __va_list *ap);
size_t mg_print_mac(void (*out)(char, void *), void *arg, __va_list *ap);
...
size_t mg_vprintf(struct mg_connection *, const char *fmt, __va_list *ap);
...
void mg_rpc_vok(struct mg_rpc_req *, const char *fmt, __va_list *ap);
void mg_rpc_err(struct mg_rpc_req *, int code, const char *fmt, ...);
void mg_rpc_verr(struct mg_rpc_req *, int code, const char *fmt, __va_list *);
