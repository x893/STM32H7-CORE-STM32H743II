...
Screen1ViewBase::Screen1ViewBase()
{
    ...
    box1.setColor(touchgfx::Color::getColorFromRGB(8, 218, 255));
    add(box1);

    buttonWithLabel1.setXY(392, 275);
    ...
    buttonWithLabel1.setLabelText(touchgfx::TypedText(T___SINGLEUSE_DWG0));
